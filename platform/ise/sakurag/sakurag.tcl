# 
# Project automation script for sakurag 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source sakurag.tcl), then you can
...
set myProject "sakurag"
set myScript "sakurag.tcl"
...
proc add_source_files {} {
   ...
   xfile add "dut.v"
   xfile add "sakura_g_main_r1.ucf"
   xfile add "sca_unlock_post.v"

   # Set the Top Module as well...
   project set top "sca_unlock_top"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/kaveh/projects/scadobf/ise/sakurag/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "sca_unlock_top" -process "Generate IBIS Model"
